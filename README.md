...
<<<<<<< Updated upstream
=======
For further documentation about Cohort Buider Open Web App see
...
<p><b>Adding Application link to the reference application</b> </p>
...
````
Save changes, now Concept OWA is visible at the homepage
